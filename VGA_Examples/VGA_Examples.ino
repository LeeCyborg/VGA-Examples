...
// These are images, i find it easiest to use binary 
...
const unsigned char img_data[IMG_SPRITES_CNT][IMG_HEIGHT][IMG_BWIDTH] PROGMEM = {
  { {  0b10101010,   0b01010101,   0b00110110,   0b11111111, },
    {  0b10101010,   0b01010101,   0b00110110,   0b11111111, },
    {  0b10101010,   0b01010101,   0b00110110,   0b11111111, },
    {  0b10101010,   0b01010101,   0b00110110,   0b11111111, },
    {  0b10101010,   0b01010101,   0b00110110,   0b11111111, },
...
void setup() {
  ...
  vga.begin();
  //vga.clear(11);
  // You can use a number between 0 and 255 to clear the screen, but really only 0and 3 are different 
 
  //vga.blit((byte*)(img_mario_data[cnt]), IMG_MARIO_WIDTH, IMG_MARIO_HEIGHT, VGAX_WIDTH/2, VGAX_HEIGHT/2);
   // This is the library function to display a sprite, simplified ersion is in the function below 
  ...
  // Same ting but sprite with mask 
  //vga.putpixel(50,50, 3);
  // Put Pixel is a number between 0 and 3
  //vga.putpixel4(0, VGAX_HEIGHT / 2, 0b01101100);
  // Put Pixel 4 is a string of 4 binary indicators, where 01, 10, 11, and 11 are color combos with 0b in front to indicate it is binary
}
void loop() {
  //drawRandomSprite();
...
void randomNumbers(){  // Display random pixels
    static unsigned cnt;
    cnt++;
    vga.putpixel(rand() % VGAX_WIDTH, rand() % VGAX_HEIGHT, cnt % 3);
}
...
void drawSprite(int whichSprite,int x, int y, bool mask){  
  // Which sprite in the array, x and y location, and whether to mask it
  if(mask){ 
